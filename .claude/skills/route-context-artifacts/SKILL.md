...
3. **Draft `context.aml`** from the Test 5 set only, using `../new-analytics-onboarding/references/context-template.md`.
...
9. **Scaffold the repo `AGENTS.md`** from `../new-analytics-onboarding/references/agents-md-scaffold.md` if the customer has
   an AMQL repo.
