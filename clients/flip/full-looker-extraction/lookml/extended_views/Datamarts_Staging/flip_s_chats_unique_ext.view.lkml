  include: "/base_views/Datamarts_Staging/flip_s_chats_unique_base.view"
view: flip_s_chats_unique_ext {
  extends: [flip_s_chats_unique_base]
...
#---DIMENSIONS----------------------------
  ...
  dimension: chat_type {
    type: string
    description: "Distinction between private chat, group chats, and AI chats."
  }
