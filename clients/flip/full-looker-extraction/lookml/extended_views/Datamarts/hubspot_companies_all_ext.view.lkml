...
# ------- MEASURES ------------
  ...
  measure: count {
    type: count
    label: "# Companies"
    drill_fields: [company_id, company_name, company_allocation, last_initial_meeting_booked_company_date, last_initial_meeting_scheduled_company_date, company_bdr_name, company_bdr_team_name, company_owner, last_initial_meeting_record_id]
  }
  ...
  measure: number_of_initial_meetings_company_avg {
    ...
    drill_fields: [company_id, company_allocation, company_bdr_name, company_owner, days_from_initial_meeting_to_sao,  last_initial_meeting_booked_company_date, deal_new_logo_dmt_sao_date, last_initial_meeting_record_id]
  }
  ...
  measure: last_initial_meeting_record_id_count { # 1:1 with company_id (PK) BUT Record ID is not always being filled yet. Work in progress with Louis 2025-06-20
    ...
    drill_fields: [company_id, company_name, company_allocation, last_initial_meeting_record_id, last_initial_meeting_booked_company_date, last_initial_meeting_scheduled_company_date, company_bdr_name, company_owner, company_bdr_team_name]
  }
  ...
  measure: days_from_booked_meeting_to_scheduled_avg {
    ...
    drill_fields: [company_id, company_allocation, company_bdr_name, company_owner, days_from_booked_meeting_to_scheduled,  last_initial_meeting_booked_company_date, last_initial_meeting_scheduled_company_date, last_initial_meeting_record_id]
    value_format_name: decimal_0
  }
