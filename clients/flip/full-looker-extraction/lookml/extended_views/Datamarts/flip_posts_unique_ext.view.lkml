...
view: flip_posts_unique_ext {
  ...
  drill_fields: [post_id, post_title, channel_name, created_timestamp_date, detected_language, post_body_word_count]
...
# --- FIELDS -------
  ...
  set: all_date_fields { # not complete yet
    fields:
    [first_highlighted_at_timestamp_date, first_highlighted_at_timestamp_month, first_highlighted_at_timestamp_quarter, first_highlighted_at_timestamp_raw,
      first_highlighted_at_timestamp_time, first_highlighted_at_timestamp_week, first_highlighted_at_timestamp_year,
      highlighted_until_timestamp_date, highlighted_until_timestamp_day_of_week, highlighted_until_timestamp_hour_of_day, highlighted_until_timestamp_month,
      highlighted_until_timestamp_quarter, highlighted_until_timestamp_raw, highlighted_until_timestamp_time, highlighted_until_timestamp_week, highlighted_until_timestamp_year,
      updated_timestamp_date, updated_timestamp_day_of_week, updated_timestamp_month, updated_timestamp_quarter, updated_timestamp_raw, updated_timestamp_time, updated_timestamp_week, updated_timestamp_year,
      db_row_timestamp_date, db_row_timestamp_day_of_week, db_row_timestamp_month, db_row_timestamp_quarter, db_row_timestamp_raw, db_row_timestamp_time, db_row_timestamp_week, db_row_timestamp_year]
  }

  set: exclude_for_privacy_protection {
    fields: [channel_name, post_title, count_cs, count_percent_cs]
  }

  set: exclude_numeric_dimensions {
    fields: [attachment_count, bookmark_count, comment_count, comment_reaction_count, diff_scheduled_created_minutes, diff_scheduled_published_minutes,
        highlight_duration_hours, highlight_duration_days, highlighted_until_count,
       post_body_character_count, post_seen_count, reaction_count,
      scheduled_count, survey_vote_count, translated_languages_count]
    #post_body_word_count, updated_count, survey_choice_count,
  }

  set: not_relevant_for_cs_explores {
    fields: [
      attachment_count,attachment_count_avg,

      count,count_percent,diff_scheduled_created_minutes,
      diff_scheduled_created_minutes_avg, diff_scheduled_created_minutes_tier,
      ...
      is_was_highlight_removed,post_body_character_count,post_body_character_count_sum,post_body_word_count, post_body_word_count_max,post_body_word_count_min,post_body_word_count_tiers,
      post_body_word_count_sum,channel_id,

      post_seen_count,post_seen_count_avg,post_seen_count_max,post_seen_count_sum,

      scheduled_count,scheduled_count_sum,

      tenant,translated_languages_count,updated_count,updated_count_max,updated_count_tier, tenant,

      db_row_timestamp_date, db_row_timestamp_day_of_week, db_row_timestamp_month, db_row_timestamp_quarter, db_row_timestamp_raw, db_row_timestamp_time, db_row_timestamp_week, db_row_timestamp_year,
      first_highlighted_at_timestamp_date, first_highlighted_at_timestamp_month, first_highlighted_at_timestamp_quarter, first_highlighted_at_timestamp_raw,
      first_highlighted_at_timestamp_time, first_highlighted_at_timestamp_week, first_highlighted_at_timestamp_year,
      highlighted_until_timestamp_date, highlighted_until_timestamp_day_of_week, highlighted_until_timestamp_hour_of_day, highlighted_until_timestamp_month, highlighted_until_timestamp_quarter, highlighted_until_timestamp_raw,
      highlighted_until_timestamp_time, highlighted_until_timestamp_week, highlighted_until_timestamp_year,
      updated_timestamp_date, updated_timestamp_day_of_week, updated_timestamp_month, updated_timestamp_quarter, updated_timestamp_raw, updated_timestamp_time, updated_timestamp_week, updated_timestamp_year,
      db_row_timestamp_date, db_row_timestamp_month, db_row_timestamp_quarter, db_row_timestamp_raw, db_row_timestamp_time, db_row_timestamp_week, db_row_timestamp_year
      ]
