...
# ----- DIMENSIONS --------------------------------------------------------
  ...
  dimension_group: contract_start {
    ...
    dimension: country {
      ...
      drill_fields: [company_id, company_name, ae_name, cs_name]
  ...
  dimension: is_edeka_company { # needs to be renamed to avoid problems when combining with deals table (multiple occurence)
    sql: ${is_edeka} ;;
    type: yesno
    hidden: yes
    }
  ...
  dimension: translation_limit_monthly {
    type: string
  }
...
# ----- NEW DIMENSIONS --------------------------------------------------------
  ...
  dimension: segment_cs_edeka {
    type: string
    sql: CASE
          WHEN ${is_edeka} IS true THEN "0. Edeka"
          ELSE ${company_segment} END;;
    label: "Segment CS (incl. Edeka)"
    description: "Customer Segments with the differentiation of Edeka vs Smart (for CS)"
  }
  ...
  dimension: is_strategic_customer { # defined by Hannes & Lisa
    type: yesno
    sql: ${tenant} IN ("tenant-0004", "tenant-0260", "tenant-0253", "tenant-0166", "tenant-0263", "tenant-0197", "tenant-0264", "tenant-0167",
    "tenant-0003", "tenant-0007", "tenant-0297", "tenant-0151", "tenant-0196", "tenant-0012", "tenant-0292", "tenant-0210", "tenant-0151", "tenant-0168",
    "tenant-0302", "tenant-0026", "tenant-0264") OR ${is_edeka_company} IS true;;
    label: "Is strategic Customer "
  }
...
# }
  ...
  set: all_flipsters_usage_relevant { # for combination with usage data in "all flipsters" model -> visible for all looker users
    fields: [
      company_name, company_name_groups, fin_customer_group_id, fin_customer_group_name,
      count_distinct_customer_groups, count, count_customer_contracts, percent_of_total, percent_of_total_customer_contracts, percent_of_total_customer_groups,
      company_id, ae_name, cs_name, is_company_licence, number_of_associated_deals, number_of_associated_deals_sum,
      health_score_tiers, vitally_overall_health_score, overall_health_score_avg, country, current_contract_term__in_months_tiers, current_arr_euros_tiers,
      churn_date, churn_month, churn_quarter, churn_year,
      contract_start_date, contract_start_month, contract_start_quarter, contract_start_year,
      newlogo_signed_date, newlogo_signed_month, newlogo_signed_quarter, newlogo_signed_year,
      newlogo_last_7d_dimension, newlogo_last_14d_dimension, newlogo_last_30d_dimension, company_partner_marker,
      licence_success_rate_avg, licence_success_rate, licence_success_rate_sold_avg, licences_sold_sum,
      onboarding_rate_avg,segment_cs_edeka,vitally_customer_journey_stage, number_of_employees_sum,
      vitally_app_handover_date, vitally_app_handover_month, vitally_app_handover_quarter, vitally_app_handover_raw, vitally_app_handover_year,
      go_live_date, go_live_month, go_live_quarter, go_live_raw, go_live_year,
      industry, industry_simplified_investors, is_edeka, is_strategic_customer, pricing_package_estimated,
      integration, technical_setup, additional_developments, legal_information,
      vitally_overall_health_score, company_allocation, company_segment, fin_customer_group_segment_investor, vitally_lifecycle, nps_avg, count, tenant,
      dau_30d_avg_sum, mau_count_sum, wau_count_sum, dau_onboarded_net_avg, wau_onboarded_net_avg, mau_onboarded_net_avg, dau_30d_licences_sold_percentage, wau_licences_sold_percentage, mau_licences_sold_percentage,
      users_created_net_sum, users_onboarded_net_sum, licences_tenant_controller_sum, users_onboarded_net_sum,count_accounts_with_higher_65_percent_wau_license_sold,has_active_flows,
      is_ai_assistant_user_groups_activated, is_ai_assistant_activated, renewal_date_date]
  }
