...
# --- MEASURES ---------------------------------------------------------
  ...
  set: tenant_fields_irrelevant_for_all_flip_explores {
    fields: [
      db_row_timestamp_date, db_row_timestamp_month, db_row_timestamp_quarter, db_row_timestamp_time, db_row_timestamp_raw, db_row_timestamp_year,
      db_row_timestamp_domain_date, db_row_timestamp_domain_month, db_row_timestamp_domain_quarter, db_row_timestamp_domain_time, db_row_timestamp_domain_raw, db_row_timestamp_domain_year,
      db_row_timestamp_locale_date, db_row_timestamp_locale_month, db_row_timestamp_locale_quarter, db_row_timestamp_locale_time, db_row_timestamp_locale_raw, db_row_timestamp_locale_year,
      ]
  }
