include: "/base_views/Datamarts/flip_chat_memberships_unique_base.view"

view: flip_chat_memberships_unique_ext {

  extends: [flip_chat_memberships_unique_base]
...
#--------------DIMENSIONS-----------------------------------------------------------
  ...
  dimension: deletion_status {
    type: string
    description: "Values: NOT_DELETED, DELETED, USER_DELETED, CHAT_DELETED."
  }
