include: "/base_views/Datamarts/flip_attachments_unique_base.view"

  view: flip_attachments_unique_ext {

    extends: [flip_attachments_unique_base]

    drill_fields: [attachment_id, attachment_element_type, attachment_media_type, created_timestamp_date, tenant, is_attachment_deleted ]
...
#--------------MEASURES------------------------
    ...
    measure: attachment_element_id_count_distinct {
      type: count_distinct
      sql: ${attachment_element_id} ;;
      label: "# Attachment Elements"
      description: "Count of distinct attachment_element_id."
    }

    measure: attachment_file_size_sum_test {
      type: sum
      label: "File Size (Total)"
      sql: ${attachment_file_size}/1024;;
      #value_format_name: decimal_1
      value_format: "[>=1000000]0.#,,\" GB\";[>=1000000]0.#,,\" MB\";0.#,\" B\""
      }
...
# --- SETS
  ...
  set: attachments_irrelevant_for_all_flip {
    fields: [tenant]
  }
