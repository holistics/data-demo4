include: "/base_views/Datamarts/flip_chat_messages_unique_base.view"

view: flip_chat_messages_unique_ext {

  extends: [flip_chat_messages_unique_base]
...
# --- MANUALLY CREATED DIMENSIONS -----------------------------------
  ...
  dimension: message_langauage_tiers {
    type: tier
    sql: ${message_language_count} ;;
    tiers: [1,2,5,10,15,20]
    style: integer
  }
...
# --- MEASURES ------------------------------------------------------
  ...
  measure: message_reactions_count_sum {
    type: sum
    sql: ${message_reactions_count} ;;
