include: "/base_views/Datamarts/flip_chat_message_mentions_unique_base.view"

view: flip_chat_message_mentions_unique_ext {

  extends: [flip_chat_message_mentions_unique_base]
