view: salesloft_meetings_held_base {
  ...
  dimension: hs_associated_contact_name {
    type: string
    sql: ${TABLE}.hs_associated_contact_name ;;
  }
  ...
  dimension: hs_associated_deal_stage {
    type: string
    sql: ${TABLE}.hs_associated_deal_stage ;;
  }
  dimension: hs_associated_deal_type {
    type: string
    sql: ${TABLE}.hs_associated_deal_type ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [hs_associated_contact_name, foreign_key_date_name, hs_associated_deal_name, hs_associated_company_name]
  }
}
