view: hubspot_engagement_meetings_sales_base {
  ...
  dimension: associated_deal_stage {
    type: string
    sql: ${TABLE}.associated_deal_stage ;;
  }
  dimension: associated_deal_type {
    type: string
    sql: ${TABLE}.associated_deal_type ;;
  }
  ...
  dimension: meeting_internal_notes {
    type: string
    sql: ${TABLE}.meeting_internal_notes ;;
  }
  dimension: meeting_location {
    type: string
    sql: ${TABLE}.meeting_location ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [associated_contact_name, associated_deal_name, associated_company_name, meeting_owner_name]
  }
}
