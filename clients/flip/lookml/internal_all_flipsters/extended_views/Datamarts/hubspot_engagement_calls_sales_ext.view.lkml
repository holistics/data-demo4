...
# ----- DIMENSIONS ----------------------------------------------------------------------------------------------------------------------------------------------
  ...
  measure: calls_total_count {
    type: count_distinct
    sql: ${call_id} ;;
    drill_fields: [call_create_date_drilldown, call_id, call_owner_name, call_owner_team, call_activity_type, call_direction, call_outcome, duration_min, associated_company_name, associated_company_segment]
  }
