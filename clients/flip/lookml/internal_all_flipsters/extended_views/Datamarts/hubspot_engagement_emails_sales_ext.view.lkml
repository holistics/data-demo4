...
# ----- MEASURES --------------------------------------------------------
  ...
  measure: emails_sent_count {
    ...
    drill_fields: [email_sent_date_drilldown, email_id, associated_contact_id, associated_company_name, associated_company_segment]
    label: "Emails Sent"
  }
...
# HubSpot Users can manually log emails in HubSpot, associating it to a company or contact. They could be either a sent or a received email
  ...
  measure: emails_total_count {
    ...
    drill_fields: [email_sent_date_drilldown, email_id, email_status, associated_contact_id, associated_company_name, associated_company_segment]
    label: "Emails Total"
  }
