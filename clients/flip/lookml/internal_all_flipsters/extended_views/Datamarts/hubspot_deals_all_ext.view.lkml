...
### --- FILTERED COUNTS ------------------------------------------------------------------------------------------
  ...
  # Added Closed Won New Logos - It includes AE Pipeline and Edeka Pipeline
  ...
  # # Added Closed Won New Logos - It includes AE Pipeline and Edeka Pipeline // not needed anymore 2025/05
  ...
  # Added Closed Won Deals - It includes all AE Pipeline, Edeka Pipeline and Upsell Pipeline
  ...
  measure: deals_with_pre_sales_pre_project_count {
    ...
    drill_fields: [deal_name, deal_id, deal_type, deal_segment, deal_allocation, deal_allocation_mix, funnel_stages_ordered, bdr_name, presales_name, ae_name, presales_1_pre_project_delivery_date_drilldown, close_date_drilldown, current_amount_sum_euros, licences_sum]
  }
  ...
  measure: deals_with_pre_sales_discovery_count {
    ...
    drill_fields: [deal_name, deal_id, deal_type, deal_segment, deal_allocation, deal_allocation_mix, funnel_stages_ordered, bdr_name, presales_name, ae_name, presales_2_discovery_delivery_date_drilldown, close_date_drilldown, current_amount_sum_euros, licences_sum]
  }
  ...
  measure: deals_with_pre_sales_demo_count {
    ...
    drill_fields: [deal_name, deal_id, deal_type, deal_segment, deal_allocation, deal_allocation_mix, funnel_stages_ordered, bdr_name, presales_name, ae_name, presales_3_demo_delivery_date_drilldown, close_date_drilldown, current_amount_sum_euros, licences_sum]
  }
...
##### ----- FILTERED: One-Time Revenue ------------------------------------------------------------------------
  ...
  measure: net_arr_sum_euros {
    ...
    #filters: [dmt_happy_call_all_date: "-NULL", pipeline_label: "AE Pipeline, Edeka Pipeline, Upsell Pipeline"]
    ...
    drill_fields: [company_name_groups, net_arr_sum_euros, signed_arr_upsells_sum_euros, new_added_upsells_count]
    value_format: "[>=1000000]€#0.000,,\" M\";[>=1000]€#0.00,\" K\";[<1000]€#0.00;0"
  }
...
# Added ARR Potential in Commit
  measure: commit_arr_sum_euros {
    ...
    label: "€ Committed ARR"
    drill_fields: [close_date_drilldown, deal_name, forecast_category, next_step_date_drilldown, deal_owner_name, sales_region, deal_segment, deal_allocation, deal_allocation_mix, current_amount_sum_euros]
    value_format: "[>=1000000]€#0.000,,\" M\";[>=1000]€#0.00,\" K\";[<1000]€#0.00;0"
  }
...
# Added ARR Potential in all forecast categories
  measure: closing_arr_sum_euros {
    ...
    drill_fields: [close_date_drilldown, deal_name, deal_type, deal_allocation, forecast_category, stage_label, deal_stage_probability, next_step_date_drilldown, deal_owner_name, current_amount_sum_euros]
    # value_format: "[>=1000000]€#0.000,,\" M\";[>=1000]€#0.00,\" K\";[<1000]€#0.00;0"
    value_format: "€#,##0"
...
# Added ARR Potential in all forecast categories
  measure: closing_arr_weighted_sum_euros {
    ...
    drill_fields: [close_date_drilldown, deal_name, deal_type, forecast_category, stage_label, deal_stage_probability, next_step_date_drilldown, deal_owner_name, sales_region, deal_segment, deal_allocation, deal_allocation_mix, current_amount_sum_euros]
    # value_format: "[>=1000000]€#0.000,,\" M\";[>=1000]€#0.00,\" K\";[<1000]€#0.00;0"
    value_format: "€#,##0"
...
# Count of Opportunities in all forecast categories
  measure: closing_opportunities_count {
    ...
    drill_fields: [close_date_drilldown, deal_name, deal_type, forecast_category, stage_label, next_step_date_drilldown, deal_owner_name, sales_region, deal_segment, deal_allocation, deal_allocation_mix, current_amount_sum_euros]
  }
...
# NRR parametrized (monthly): BASE revenue
  ...
  # NRR parametrized (monthly): all ARR deals of Cohort customers churned in current period
    # new logo Edekas that are created in 12m and churn in same year are excluded from Edeka New Logo instead of being listed here
  ...
  measure: nrr_params_expansion_downsell_euros {
    ...
    sql:
      CASE
        ...
        -- #2 Edeka Upsells from Edeka Stores being part of the Edeka Cohort (need to be considered by closed_won_customer_date (instead of group)):
          -- Deal must be closed won:
        WHEN stage_label = "Closed Won"
        ...
        -- #3 Expansion deals (non-Edeka, as Edeka is considered Upsell instead of Expansion):
          -- Deal must be closed won:
        WHEN stage_label = "Closed Won"
...
#-------------
  ...
  #       -- AND ${deal_type} IN ("Upsell", "Upsell EDEKA") -- old
  ...
  #   # dmt_happy_call_all_year: "2022", deal_id: "-10684559926, -10684559031, -8410408752"] # excluding build-in expansions from two named strategic accounts (upsell pipeline)
  # }
#----------
...
### ---- SALES FUNNEL SPECIFIC MEASURES ----------------------------------------------------------------------
  ...
  measure: sales_cycle_length_sao_to_closed_avg {
    ...
    sql:  CASE WHEN ${stage_label} = "Closed Won" THEN DATE_DIFF(${dmt_closed_won_date},${dmt_sao_date},day)
          ELSE NULL END;;
    value_format: "#,###"
    drill_fields: [deal_name, deal_id, deal_segment, deal_allocation, deal_allocation_mix, number_of_employees, number_of_employees_tiers, deal_owner_name, dmt_sao_drilldown, dmt_closed_won_drilldown, current_amount_sum_euros, price_per_user_avg_euros, sales_cycle_length_sao_to_closed_avg]
  ...
  measure: tcv_avg_euros {
    ...
    value_format: "[>=1000000]€#0.000,,\" M\";[>=1000]€#0.00,\" K\";[<1000]€#0.00;0"
    drill_fields: [deal_name, deal_id, deal_segment, deal_allocation, deal_allocation_mix, number_of_employees, number_of_employees_tiers, deal_owner_name, dmt_sao_drilldown, dmt_closed_won_drilldown, current_amount_sum_euros, price_per_user_avg_euros, sales_cycle_length_sao_to_closed_avg, tcv_avg_euros]
  ...
  measure: conversion_sal_to_sao { # not working yet
    ...
    value_format: "0%"
    drill_fields: [deal_id, deal_name, stage_label, deal_segment, deal_allocation, deal_allocation_mix, number_of_employees, number_of_employees_tiers, deal_owner_name, dmt_sao_drilldown, dmt_closed_won_drilldown, current_amount_sum_euros, price_per_user_avg_euros]
  ...
  measure: closed_won_count {
    ...
    sql: ${deal_id} ;;
    filters: [dmt_closed_won_date:"-NULL", new_business_vs_upsell: "New Business, Upsell"]
    drill_fields: [deal_id, deal_name, deal_type, deal_owner_name, industry_flip, deal_source_channel_cluster_hubspot, deal_source_channel_drilldown_hubspot, sales_region, deal_segment, deal_allocation, deal_allocation_mix, stage_label, contact_dmt_lead_drilldown, contact_dmt_mql_drilldown, contact_dmt_sql_drilldown, dmt_sal_drilldown, dmt_sao_drilldown, dmt_closed_won_drilldown, signed_arr_sum_euros, sales_cycle_length_sao_to_closed_avg]
    label: "#8 Closed Won"
  ...
  measure: closed_lost_count {
    ...
    drill_fields: [dmt_closed_lost_drilldown, deal_id, deal_name, deal_type, deal_owner_name, deal_segment, deal_allocation, deal_allocation_mix, industry_flip, sales_region, stage_label, current_amount_sum_euros]
  ...
  measure: nonaccepted_sals_in_lost_count {
    ...
    drill_fields: [deal_name, deal_id, deal_id, bdr_name, deal_owner_name, sales_region, deal_segment, deal_allocation, deal_allocation_mix, stage_label, dmt_sal_drilldown, dmt_closed_lost_drilldown, current_amount_sum_euros]
...
### ---- LOSS ANALYSIS DASHBOARD SPECIFIC MEASURES -----------------------------------------------------------------
  ...
  measure: dynamic_base_metric_loss_analysis {
    ...
    html: {% if base_metric_loss_analysis._parameter_value == 'arr' %} €{{ rendered_value }}
          {% else %} {{ rendered_value }}
          {% endif %} ;;
    drill_fields: [dmt_closed_lost_drilldown, deal_name, deal_owner_name, deal_segment, deal_allocation, deal_allocation_mix, industry_flip, sales_region, stage_label, current_amount_sum_euros]
  ...
  measure: dynamic_base_metric_sao {
    ...
    # value_format: "[>=1000000]#0.000,,\" M\";[>=1000]#0.00,\" K\";[<1500]#0;0"
      ...
      html: {% if base_metric_sao_loss_analysis._parameter_value == 'arr' %} €{{ rendered_value }}
          {% else %} {{ rendered_value }}
          {% endif %} ;;
      drill_fields: [dmt_closed_lost_drilldown, deal_name, lost_arr_sum_euros, deal_owner_name, deal_segment, deal_allocation, deal_allocation_mix, industry_flip, sales_region, stage_label]
...
# ---- SETS ------
  ...
  set: all_complete_date_groups {
    fields:
    [churn_date, churn_month, churn_quarter, churn_raw, churn_week, churn_year, close_date, close_month, close_quarter, close_raw, close_week, close_year, copied_at_date, copied_at_month, copied_at_quarter, copied_at_raw, copied_at_week, copied_at_year, copied_at_timestamp_date, copied_at_timestamp_month, copied_at_timestamp_quarter, copied_at_timestamp_raw, copied_at_timestamp_week, copied_at_timestamp_year, created_at_date, created_at_month, created_at_quarter, created_at_raw, created_at_week, created_at_year, churned_date_customer_date, churned_date_customer_month, churned_date_customer_quarter, churned_date_customer_raw, churned_date_customer_week, churned_date_customer_year, churned_date_group_date, churned_date_group_month, churned_date_group_quarter, churned_date_group_raw, churned_date_group_week, churned_date_group_year, dmt_closed_won_customer_date, dmt_closed_won_customer_month, dmt_closed_won_customer_quarter, dmt_closed_won_customer_raw, dmt_closed_won_customer_week, dmt_closed_won_customer_year, dmt_closed_won_group_date, dmt_closed_won_group_month, dmt_closed_won_group_quarter, dmt_closed_won_group_raw, dmt_closed_won_group_week, dmt_closed_won_group_year, contract_start_date, contract_start_month, contract_start_quarter, contract_start_raw, contract_start_week, contract_start_year, dmt_closed_lost_date, dmt_closed_lost_month, dmt_closed_lost_quarter, dmt_closed_lost_raw, dmt_closed_lost_week, dmt_closed_lost_year, dmt_closed_won_date, dmt_closed_won_month, dmt_closed_won_quarter, dmt_closed_won_raw, dmt_closed_won_week, dmt_closed_won_year, dmt_closed_won_validation_date, dmt_closed_won_validation_month, dmt_closed_won_validation_quarter, dmt_closed_won_validation_raw, dmt_closed_won_validation_week, dmt_closed_won_validation_year, dmt_evaluation_date, dmt_evaluation_month, dmt_evaluation_quarter, dmt_evaluation_raw, dmt_evaluation_week, dmt_evaluation_year, dmt_negotiations_date, dmt_negotiations_month, dmt_negotiations_quarter, dmt_negotiations_raw, dmt_negotiations_week, dmt_negotiations_year, dmt_proposal_date, dmt_proposal_month, dmt_proposal_quarter, dmt_proposal_raw, dmt_proposal_week, dmt_proposal_year, dmt_sal_date, dmt_sal_month, dmt_sal_quarter, dmt_sal_raw, dmt_sal_week, dmt_sal_year, dmt_sao_date, dmt_sao_month, dmt_sao_quarter, dmt_sao_raw, dmt_sao_week, dmt_sao_year, dmt_solution_design_date, dmt_solution_design_month, dmt_solution_design_quarter, dmt_solution_design_raw, dmt_solution_design_week, dmt_solution_design_year, go_live_date, go_live_month, go_live_quarter, go_live_raw, go_live_week, go_live_year, last_activity_date, last_activity_month, last_activity_quarter, last_activity_raw, last_activity_week, last_activity_year, last_contacted_date, last_contacted_month, last_contacted_quarter, last_contacted_raw, last_contacted_week, last_contacted_year, next_step_date, next_step_month, next_step_quarter, next_step_raw, next_step_week, next_step_year, renewal_date, renewal_month, renewal_quarter, renewal_raw, renewal_time, renewal_week, renewal_year]
  }

  set: all_datamart_hubspot_customers_all_related_fields {
    fields: [nrr_params_base_euros, nrr_params_churned_revenue_euros, nrr_params_expansion_downsell_euros, nrr_params_base_euros, nrr_params_expansion_edeka_euros, nrr_ext_params_upsell_new_logo_euros, nrr_ext_params_euros, nrr_ext_params_percent]
  }

  set: all_net_retention_fields {
    fields: [base_cohort, nrr_params_base_euros, nrr_params_expansion_downsell_euros, nrr_params_churned_revenue_euros, nrr_params_expansion_edeka_euros, nrr_params_euro, nrr_params_percent, nrr_ext_params_upsell_new_logo_euros, nrr_ext_params_pilot_values_euros, nrr_ext_params_pilot_newlogo_euros, nrr_ext_params_euros, nrr_ext_params_percent]
  }

  set: nrr_all_flipster_additional_fields {
    fields: [churn_date, churn_month, churn_quarter, churn_week, churn_year, dmt_closed_won_group_date, dmt_closed_won_group_month, dmt_closed_won_group_quarter, dmt_closed_won_group_week, dmt_closed_won_group_year, churned_date_group_date, churned_date_group_month, churned_date_group_quarter, churned_date_group_week, churned_date_group_year, current_amount_sum_euros, deal_id, deal_name, deal_type, expansion_deal, pipeline_label, stage_label, deal_segment, customer_is_pov_conversion, customer_is_pov_conversion_no_expansion]
  }

  set: all_gross_retention_fields {
    fields: [base_cohort, negative_positive_amounts, nrr_params_base_euros, nrr_params_churned_revenue_euros, grr_params_downsell_euros, grr_params_euro, grr_params_percent]
  }

## ----- TEAM SPECIFIC SETS (for Explores) -----------------------------------------------------------------------------------

  set: all_cs_relevant_fields {
    fields: [contract_term_in_months, cs_name, deal_id, deal_name, deal_type, new_business_vs_upsell, deals_relevant_for_cs, has_integration, industry_flip, deal_allocation, is_mtd, is_ytd, is_churned, is_churned_today, is_lost_revenue, is_recurring, is_license_overrun_deal, months_since_go_live_floor, negative_positive_amounts, pipeline_label, presales_name, revenue_signed_date, sales_region, deal_segment, stage_label, customer_is_pov_conversion, customer_is_pov_conversion_no_expansion, expansion_deal, stage_label, deal_source_channel_cluster_hubspot, forecast_category, close_date, close_month, close_quarter, close_week, close_year, churn_date, churn_month, churn_quarter, churn_week, churn_year, dmt_closed_won_customer_date, dmt_closed_won_customer_month, dmt_closed_won_customer_quarter, dmt_closed_won_customer_raw, dmt_closed_won_customer_week, dmt_closed_won_customer_year, dmt_closed_won_group_date, dmt_closed_won_group_month, dmt_closed_won_group_quarter, dmt_closed_won_group_week, dmt_closed_won_group_year, churned_date_customer_date, churned_date_customer_month, churned_date_customer_quarter, churned_date_customer_raw, churned_date_customer_week, churned_date_customer_year, churned_date_group_date, churned_date_group_month, churned_date_group_quarter, churned_date_group_week, churned_date_group_year, contract_start_date, contract_start_month, contract_start_quarter, contract_start_week, contract_start_year, dmt_closed_won_date, dmt_closed_won_month, dmt_closed_won_quarter, dmt_closed_won_week, dmt_closed_won_year, dmt_negotiations_date, dmt_negotiations_month, dmt_negotiations_quarter, dmt_negotiations_week, dmt_negotiations_year, dmt_sao_date, dmt_sao_month, dmt_sao_quarter, dmt_sao_raw, dmt_sao_week, dmt_sao_year, renewal_date, renewal_month, renewal_quarter, renewal_raw, renewal_time, renewal_week, renewal_year, count, licences_sum, licences_upsell_sum, new_added_upsells_count, current_amount_sum_euros, total_contract_value_sum_euros, total_recurring_contract_value_sum_euros, one_off_deal_amount_sum_euros, setup_amount, one_off_total_amount_sum_euros, signed_arr_sum_euros, signed_arr_avg_euros, churned_arr_sum_euros, downsell_arr_sum_euros, lost_arr_sum_euros, net_arr_sum_euros, signed_arr_upsells_sum_euros, signed_arr_new_logos_sum_euros, added_one_time_revenue_sum_euros, net_one_time_revenue_sum_euros, sales_cycle_length_sao_to_closed_avg, all_net_retention_fields*]
  }
  # -- sao_to_closed and dmt_sao should be removed when separated

  set: all_flipsters_fields {
    fields: [contract_term_in_months, ae_name, bdr_name, cs_name, deal_allocation, deal_allocation_mix, deal_id, deal_name, deal_type, new_business_vs_upsell, has_integration, industry_flip, is_mtd, is_ytd, is_churned, is_churned_today, is_lost_revenue, is_recurring, is_key_deal, is_a_meta_deal, is_license_overrun_deal, months_since_go_live_floor, negative_positive_amounts, pipeline_label, presales_name, revenue_signed_date, sales_region, deal_source_channel_cluster_hubspot, deal_segment, deal_allocation, final_meddic_deal_health_score_computation, stage_label, customer_is_pov_conversion, expansion_deal, stage_label, presales_1__pre_project_pitched, presales_1__pre_project_won, presales_1__pre_project_won_yn, presales_1_pre_project_delivery_date, presales_1_pre_project_delivery_month, presales_1_pre_project_delivery_quarter, presales_1_pre_project_delivery_week, presales_1_pre_project_delivery_year, presales_1__pre_project_pitched_date, presales_1__pre_project_pitched_month, presales_1__pre_project_pitched_quarter, presales_1__pre_project_pitched_week, presales_1__pre_project_pitched_year, presales_1__pre_project_won_date, presales_1__pre_project_won_month, presales_1__pre_project_won_quarter, presales_1__pre_project_won_week, presales_1__pre_project_won_year, total_contract_value_avg_euros, churn_date, churn_month, churn_quarter, churn_week, churn_year, close_date_drilldown, close_date, close_month, close_quarter, close_week, close_year, dmt_closed_won_customer_date, dmt_closed_won_customer_month, dmt_closed_won_customer_quarter, dmt_closed_won_customer_raw, dmt_closed_won_customer_week, dmt_closed_won_customer_year, dmt_closed_won_group_date, dmt_closed_won_group_month, dmt_closed_won_group_quarter, dmt_closed_won_group_week, dmt_closed_won_group_year, churned_date_group_date, churned_date_group_month, churned_date_group_quarter, churned_date_group_week, churned_date_group_year, contract_start_date, contract_start_month, contract_start_quarter, contract_start_week, contract_start_year, dmt_closed_won_date, dmt_closed_won_month, dmt_closed_won_quarter, dmt_closed_won_week, dmt_closed_won_year, renewal_date, renewal_month, renewal_quarter, renewal_raw, renewal_time, renewal_week, renewal_year, dmt_sao_date, dmt_sao_month, dmt_sao_quarter, dmt_sao_year, created_at_date, count, licences_sum, licences_upsell_sum, new_added_upsells_count, current_amount_sum_euros, total_contract_value_sum_euros, total_recurring_contract_value_sum_euros, one_off_deal_amount_sum_euros, setup_amount, one_off_total_amount_sum_euros, signed_arr_sum_euros, signed_arr_avg_euros, churned_arr_sum_euros, downsell_arr_sum_euros, lost_arr_sum_euros, net_arr_sum_euros, signed_arr_upsells_sum_euros, signed_arr_new_logos_sum_euros, added_one_time_revenue_sum_euros, net_one_time_revenue_sum_euros]
