...
# creating parameter for enabling glanularity in the timeseries charts
  ...
  measure: count {
    type: count
    label: "# Deals"
    drill_fields: [close_date_drilldown, deal_name, forecast_category, stage_label, next_step_date_drilldown, dmt_sao_date_drilldown, ae_name, sales_region, deal_segment, current_amount_sum_euros]
  }
...
# ----- FORECAST VOLUMES ------------------------------------------------------------------
  ...
  measure: closing_arr_sum_euros {
    ...
    drill_fields: [close_date_drilldown, deal_name, forecast_category, stage_label, next_step_date_drilldown, ae_name, sales_region, deal_segment, current_amount_sum_euros]
    value_format: "[>=1000000]€#0.000,,\" M\";[>=1000]€#0.00,\" K\";[<1000]€#0.00;0"
  }
  ...
  measure: closing_arr_all_sum_euros {
    ...
    label: "Closing ARR €"
    drill_fields: [copied_at_date_drilldown, close_date_drilldown, deal_name, forecast_category, sales_region, deal_segment, ae_name, stage_label, next_step_date_drilldown, current_amount_sum_euros]
    value_format: "[>=1000000]€#0.000,,\" M\";[>=1000]€#0.00,\" K\";[<1000]€#0.00;0"
  }
...
# ----- VOLUME PER STAGE ------------------------------------------------------------------
  ...
  measure: sao_current_amount_sum_euros {
    ...
    drill_fields: [copied_at_date_drilldown, close_date_drilldown, deal_name, deal_type, sales_region, deal_segment, ae_name, stage_label, forecast_category, next_step_date_drilldown, current_amount_sum_euros]
    value_format: "[>=1000000]€#0.000,,\" M\";[>=1000]€#0.00,\" K\";[<1000]€#0.00;0"
  }
...
# ----- VOLUME CHANGES --------------------------------------------------------------------
  ...
  #   # drill_fields: [copied_at_date_drilldown, deal_name, ae_name, current_amount_sum_euros, previous_amount, change_in_amount_vs_previous_day_sum_euros]
  #   value_format: "[>=1000000]€#0.000,,\" M\";[>=1000]€#0.00,\" K\";[<1000]€#0.00;0"
  #   hidden: yes
  # }
  ...
  #   drill_fields: [copied_at_date_drilldown, deal_name, stage_label, ae_name, change_in_amount_vs_previous_day_sum_euros, previous_amount_sum_euros, current_amount_sum_euros]
  #   value_format: "\"€\"#,##0"
  # }
